...
//
#include "component_neighborhood.hpp"
#include "ExampleEvent.hpp"
#include <iostream>
...
NeighborhoodComponent::NeighborhoodComponent(SST::ComponentId_t id, SST::Params &params) :
    SST::Component(id),
    componentId_(id),
    clockTickCount_(0)
{
    ...
    port_a = configureLink("road0");
    port_b = configureLink("road1");
    ...
    registerClock(clock,
        new SST::Clock::Handler<NeighborhoodComponent>(this, &NeighborhoodComponent::clockTick));
...
//
void NeighborhoodComponent::setup(void)
{
...
//
void NeighborhoodComponent::finish(void)
{
...
// Clock event handler.
//
bool NeighborhoodComponent::clockTick(SST::Cycle_t cycle)
{
