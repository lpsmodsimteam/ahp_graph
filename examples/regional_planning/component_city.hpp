...
#ifndef MY_CITY_COMPONENT
#define MY_CITY_COMPONENT
...
namespace BuildingsAndRoads
{
    ...
    //
    class CityComponent : public SST::Component
    {
        ...
        public:
            ...
            CityComponent(SST::ComponentId_t id, SST::Params &params);
            ...
            SST_ELI_REGISTER_COMPONENT(
                CityComponent,                       // Class name
                "city",                              // Library name (the *.so)
                "CityComponent",                     // Name used to reference the component.  This can be
