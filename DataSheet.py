...
def load(filename: str) -> dict:
    ...
    Filter comments and apply a simple recursive math function
...
def __recurse_math_expr(dict_like) -> dict:
    ...
    Replace all strings that start with "=" with a scalar by evaluating
    the substring following the equals.
    Recurse if the database entry is a dictonary-like object.
    """
